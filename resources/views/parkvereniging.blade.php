...
@section('content')
    <section id="content" style="padding-top:25px; width: calc(100% - 250px);float: right">
        <div class="card mb-3">
            <img class="card-img-top" src="image/big_foto_header.jpg" align="foto1" alt="Card image cap">
            <div class="card-body">
                <h3 class="card-title" style="color: forestgreen">Vereniging vrienden polderpark Cronesteyn</h3>
                ...
                <div class="container" style="color:green" width="2500" height="3500">
                    <img src="image/Evert%20Cornet.jpg" width="250" height="365" alt="Ever Cornet designer van het park cronesteyn">
                    <img src="image/daslook%201.jpg" width="250" height="365" alt="bloem">
                </div>
                <p class="card-text">Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum.
                    ...
                    Nunc nec neque. Phasellus leo dolor, tempus non, auctor et, hendrerit quis, nisi.</p>
